...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Relatori Alun</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-naran">
                                        ...
                                        <td class="value"> <?php echo $data['naran']; ?></td>
                                    </tr>
                                    <tr  class="td-sexo">
                                    ...
                                    <tr  class="td-fatin_moris">
                                        ...
                                        <td class="value"> <?php echo $data['fatin_moris']; ?></td>
                                    </tr>
                                    <tr  class="td-data_registu">
                                        <th class="title"> Data Registu: </th>
                                        <td class="value"> <?php echo $data['data_registu']; ?></td>
                                    </tr>
                                    <tr  class="td-tinama_remata">
                                        <th class="title"> Tinama Remata: </th>
                                        <td class="value"> <?php echo $data['tinama_remata']; ?></td>
                                    </tr>
                                    <tr  class="td-id_departamentu">
                                        <th class="title"> Id Departamentu: </th>
                                        <td class="value"> <?php echo $data['id_departamentu']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-id_suku">
                                        ...
                                        <td class="value"> <?php echo $data['id_suku']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-imagen">
                                        ...
                                        <td class="value"> <?php echo $data['imagen']; ?></td>
                                    </tr>
                                    <tr  class="td-tinan_hahu_rejistu">
                                        <th class="title"> Tinan Hahu Rejistu: </th>
                                        <td class="value"> <?php echo $data['tinan_hahu_rejistu']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
