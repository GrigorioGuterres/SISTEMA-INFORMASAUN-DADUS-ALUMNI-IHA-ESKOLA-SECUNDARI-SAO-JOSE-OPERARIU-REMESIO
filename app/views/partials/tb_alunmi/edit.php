...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Tb Alunmi</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("tb_alunmi/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-fatin_moris"  value="<?php  echo $data['fatin_moris']; ?>" type="text" placeholder="Enter Fatin Moris"  required="" name="fatin_moris"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-Id_postu" data-load-path="<?php print_link('api/json/tb_alunmi_Id_postu_option_list') ?>" data-load-select-options="id_suku" name="Id_postu"  placeholder="Select a value ..."    class="custom-select" >
                                                                                <?php
                                                                                $rec = $data['Id_postu'];
                                                                                $Id_postu_options = $comp_model -> tb_alunmi_Id_postu_option_list($data['id_municipiu']);
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-id_suku" data-load-path="<?php print_link('api/json/tb_alunmi_id_suku_option_list') ?>" data-load-select-options="id_aldeia" name="id_suku"  placeholder="Select a value ..."    class="custom-select" >
                                                                                <?php
                                                                                $rec = $data['id_suku'];
                                                                                $id_suku_options = $comp_model -> tb_alunmi_id_suku_option_list($data['Id_postu']);
                                                                                if(!empty($id_suku_options)){
                                                                                foreach($id_suku_options as $option){
                                                                                $value = (!empty($option['value']) ? $option['value'] : null);
                                                                                $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                                $selected = ( $value == $rec ? 'selected' : null );
                                                                                ?>
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-id_aldeia" data-load-path="<?php print_link('api/json/tb_alunmi_id_aldeia_option_list') ?>" name="id_aldeia"  placeholder="Select a value ..."    class="custom-select" >
                                                                                <?php
                                                                                $rec = $data['id_aldeia'];
                                                                                $id_aldeia_options = $comp_model -> tb_alunmi_id_aldeia_option_list($data['id_suku']);
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <div class="dropzone required" input="#ctrl-imagen" fieldname="imagen"    data-multiple="false" dropmsg="Seleciona files No  drag Ou drop files Hodi Upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                                <input name="imagen" id="ctrl-imagen" required="" class="dropzone-input form-control" value="<?php  echo $data['imagen']; ?>" type="text"  />
                                                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                </div>
                                                                            </div>
                                                                            <?php Html :: uploaded_files_list($data['imagen'], '#ctrl-imagen'); ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
