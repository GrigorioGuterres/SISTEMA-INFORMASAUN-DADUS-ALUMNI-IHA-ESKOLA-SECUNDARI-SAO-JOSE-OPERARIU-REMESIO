...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Tb Alunmi</h4>
                </div>
                <div class="col-sm-3 ">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0 reset-grids">
                                    <div class=" ">
                                        <?php  
                                        $this->render_page("tb_alunmi/add"); 
                                        ?>
                                    </div>
                                </div>
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('tb_alunmi'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('tb_alunmi'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-fatin_moris"> Fatin Moris</th>
                                                <th  class="td-data_registu"> Data Registu</th>
                                                <th  class="td-tinan_hahu_rejistu"> Tinan Hahu Rejistu</th>
                                                <th  class="td-tinama_remata"> Tinama Remata</th>
                                                <th  class="td-id_departamentu"> Id Departamentu</th>
                                                <th  class="td-id_municipiu"> Id Municipiu</th>
                                                <th  class="td-Id_postu"> Id Postu</th>
                                                <th  class="td-id_suku"> Id Suku</th>
                                                <th  class="td-id_aldeia"> Id Aldeia</th>
                                                <th  class="td-imagen"> Imagen</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("tb_alunmi/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-naran">
                                                    ...
                                                    <td class="td-tinan_hahu_rejistu">
                                                        <span  data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                    ...
                                                    <td class="td-imagen"><?php Html :: page_img($data['imagen'],50,50,1); ?></td>
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip page-modal" title="View Record" href="<?php print_link("tb_alunmi/view/$rec_id"); ?>">
                                                            <i class="material-icons">visibility</i> Detalho Dadus
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip page-modal" title="Edit This Record" href="<?php print_link("tb_alunmi/edit/$rec_id"); ?>">
                                                            <i class="material-icons">edit</i> Hadia
                                                        </a>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("tb_alunmi/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Ita Aseita hamus Dadus nee" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("tb_alunmi/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
                                                            ...
                                                            <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                                                ...
                                                                <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                                                    ...
                                                                    <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                                        ...
                                                                        <?php Html :: import_form('tb_alunmi/import_data' , "Importa Dadus", 'CSV , JSON'); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="col">   
                                                                    <?php
