                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-naran_kompletu"  value="<?php  echo $data['naran_kompletu']; ?>" type="text" placeholder="Enter Naran Kompletu"  required="" name="naran_kompletu"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
